	...
	<form action="UserCreateAccountController" method="post">
		<div>
			...
			<br> <label for="PASSWORD"><strong>Password:</strong></label> <input
				type="password" name="pass" id="Password" list="word"
				pattern="[a-zA-Z0-9@#!.&]{8,16}" required><br>
			<br> <label for="MobileNumber"><strong>MobileNumber:</strong></label>
			<input type="tel" name="num" id="number" pattern="[6-9]{1}[0-9]{9}"
