...
<body style="text-align: center;">
	<form action="ProductController" method="post">
		<div>
			...
			<input type="text" name="bname" id="brandName" list="bname" autofocus
			...
			<br> <label for="BrandSize"><strong>Size:</strong></label>
			 <input type="number" name="bsize" id="Sizes" list="sizes" required><br>
			<br> <label for="Color"><strong>Color:</strong></label> 
			<input type="text" name="col" id="COLOR" list="COL" required><br>
			<br>
